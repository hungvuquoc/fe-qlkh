...
function WarehouseDialog({ statusFinished = false, warehouseId, item, dataProducts = [], handleClose, handleConfirm }) {
  ...
  const configInputFieldOverview = [
    {
      type: CONATINER,
                ...
                <div className={cx('sidebar-container')}>
                  <div className={cx('sidebar-container__view')}>
                    <div className={cx('overview')}>
                      <InputFieldsV2 datas={configInputFieldOverview} cx={cx} />
                    </div>
                    <hr />
